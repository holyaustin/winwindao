...
const features = [
  ...
  },
  {
    ...
    description:
      'Join us on Facebook',
    icon: LinkIcon,
    href: 'https://www.facebook.com/holyaustin/',
  },
  {
    name: 'YouTube',
    description:
  ...
  },
  {
    ...
    icon: CodeIcon,
    href: 'https://github.com/holyaustin/winwindao',
  },
            ...
            <dl className="space-y-10 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-8">
              {features.map((feature) => (feature.name === 'Open Source' ? (
                <div key={feature.name}>
                  <dt>
                    <div className="flex items-center justify-center h-20 w-20 rounded-md bg-gray-500 text-white">
                      <feature.icon className="h-16 w-16" aria-hidden="true" />
                    </div>
                    <p className="mt-10 text-lg leading-6 font-medium text-gray-900">{feature.name}</p>
                  </dt>
